...
export function mergeDbModelsWithProjectMeshes(dbItems, meshResponse) {
  ...
  const extras = meshes
    ...
    .map((mesh) => ({
      ...
      packing_method: mesh.packing_method || mesh.source_hint || mesh.format,
      mesh_id: mesh.mesh_id,
      size_bytes: mesh.size_bytes,
      from_project_scan: true,
      geometry_mode: mesh.geometry_mode,
      generation_backend: mesh.generation_backend,
      porosity_target: mesh.porosity_target,
      porosity_result: mesh.porosity_result,
      porosity_method: mesh.porosity_method,
      slice_axis: mesh.slice_axis,
      slice_thickness: mesh.slice_thickness,
      internal_cylinder_mode: mesh.internal_cylinder_mode,
      boolean_operation_status: mesh.boolean_operation_status,
      boolean_outer_shell: mesh.boolean_outer_shell,
      boolean_inner_core: mesh.boolean_inner_core,
      boolean_particle_tools: mesh.boolean_particle_tools,
      boolean_backend: mesh.boolean_backend,
      boolean_warnings: mesh.boolean_warnings,
    }));
