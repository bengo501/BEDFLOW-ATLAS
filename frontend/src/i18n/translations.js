...
export const translations = {
  pt: {
    ...
    createHubSubtitle: 'alinhado ao menu «comecar» do wizard no terminal.',
    ...
    hubPipeBlenderCfdTitle: 'pipeline blender + cfd',
    hubPipeBlenderCfdDesc: 'malha e caso openfoam; não corre o solver.',
    ...
    bedProcessBtnPipeBlenderCfd: 'finalizar: blender + caso cfd',
    ...
    meshAxes: 'eixos xyz',
    meshEduTitle: 'formato x modo (terminal)',
    meshEduLine1: 'web (three.js): stl, obj, ply, gltf, glb',
    meshEduLine2: 'desktop: open3d ou ficheiro local fora do browser',
    meshEduLine3: '.blend: use o blender; nao carrega no three.js',
  ...
  en: {
    ...
    createHubSubtitle: 'aligned with the terminal bed wizard «start» submenu.',
    ...
    hubPipeBlenderCfdTitle: 'blender + cfd pipeline',
    ...
    bedProcessBtnPipeBlenderCfd: 'confirm: blender + cfd case',
    ...
    meshAxes: 'xyz axes',
    meshEduTitle: 'format x mode (terminal parity)',
    meshEduLine1: 'web (three.js): stl, obj, ply, gltf, glb',
    meshEduLine2: 'desktop: open3d or local file outside the browser',
    meshEduLine3: '.blend: use blender; does not load in three.js',
